...
HIGH_QUALITY_GROUNDS_TREE_ASSET_PATH = "/Game/HistoricalOSM/Vegetation/HornbeamWinter/SM_Hornbeam_Field01_Winter"
HIGH_QUALITY_GROUNDS_TREE_FOLDER = "CapitolMap/Vegetation/HighQualityWinterTrees"
...
FIRST_PERSON_PLAYER_STARTS = [
    ...
    {
        "label": "CapitolMap_PlayerStart_Rotunda",
        "location_cm": [-2300.0, -2400.0, 570.0],
        "rotation_deg": [0.0, 46.2, 0.0],
        "category": "major_public_space",
        "purpose": "public Rotunda first-person inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_HouseChamber",
        "location_cm": [0.0, -10800.0, 570.0],
        "rotation_deg": [0.0, 90.0, 0.0],
        "category": "public_chamber",
        "purpose": "public House Chamber first-person inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_SenateChamber",
        "location_cm": [0.0, 10800.0, 570.0],
        "rotation_deg": [0.0, -90.0, 0.0],
        "category": "public_chamber",
        "purpose": "public Senate Chamber first-person inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_HouseGallery",
        "location_cm": [0.0, -10100.0, 570.0],
        "rotation_deg": [0.0, 90.0, 0.0],
        "category": "public_gallery",
        "purpose": "public House gallery first-person inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_SenateGallery",
        "location_cm": [0.0, 9700.0, 570.0],
        "rotation_deg": [0.0, -90.0, 0.0],
        "category": "public_gallery",
        "purpose": "public Senate gallery first-person inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_HouseOfficeWest",
        "location_cm": [-5300.0, -5500.0, 570.0],
        "rotation_deg": [0.0, 0.0, 0.0],
        "category": "generic_office_zone",
        "purpose": "generic public House support/office-zone inspection start",
    },
    {
        "label": "CapitolMap_PlayerStart_SenateOfficeEast",
        "location_cm": [5200.0, 5500.0, 570.0],
        "rotation_deg": [0.0, 180.0, 0.0],
        "category": "generic_office_zone",
        "purpose": "generic public Senate support/office-zone inspection start",
    },
]
...
ENVIRONMENT_IMPORT_SETUP = {
    ...
    "directional_light_rotation_deg": [-28.2848, 96.0626, 0.0],
    "directional_light_rotation_basis": "Target sun is elevation 28.2848 deg / true azimuth 173.9374 deg. World +X=east and +Y=north; the directional light points along reciprocal incoming rays, yielding Unreal pitch -28.2848 and yaw 96.0626 deg.",
...
FIRST_PERSON_IMPORT_SETUP = {
    ...
    "player_start_count": len(FIRST_PERSON_PLAYER_STARTS),
    "player_start_labels": [start["label"] for start in FIRST_PERSON_PLAYER_STARTS],
    "player_start_categories": sorted({start["category"] for start in FIRST_PERSON_PLAYER_STARTS}),
...
UNREAL_INSPECTION_WORKFLOWS = {
    "public_interior_cutaway": {
        "browser_route": "#interior-only",
        "camera_label": "CapitolMap_Camera_Interior_Cutaway",
        "hide_tag": INTERIOR_CUTAWAY_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_CUTAWAY_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "",
        "purpose": "Public schematic interior cutaway inspection without exterior, roof, roads, or gameplay preview meshes.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "public_interior_topdown": {
        "browser_route": "#interior-plan",
        "camera_label": "CapitolMap_Camera_PublicInterior_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "interior_plan",
        "purpose": "Public schematic interior plan inspection from the top-most camera.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "all_chambers_topdown": {
        "browser_route": "#chambers-top",
        "camera_label": "CapitolMap_Camera_Chambers_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "interior_plan",
        "purpose": "Public schematic House and Senate chamber inspection from the shared high top-down camera.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "house_chamber_plan": {
        "browser_route": "#house-plan",
        "camera_label": "CapitolMap_Camera_HouseChamber_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "house",
        "purpose": "Public schematic House chamber seating and gallery inspection.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "senate_chamber_plan": {
        "browser_route": "#senate-plan",
        "camera_label": "CapitolMap_Camera_SenateChamber_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "senate",
        "purpose": "Public schematic Senate chamber seating and gallery inspection.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "chamber_role_zones": {
        "browser_route": "#role-zones",
        "camera_label": "CapitolMap_Camera_ChamberRoleZones_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "chamber_role_overlay",
        "purpose": "Public schematic chamber role-zone inspection with generic role labels only.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "house_gallery": {
        "browser_route": "#house-gallery",
        "camera_label": "CapitolMap_Camera_HouseGallery_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "house gallery",
        "purpose": "Public schematic House gallery inspection from a high top-down camera.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
    "senate_gallery": {
        "browser_route": "#senate-gallery",
        "camera_label": "CapitolMap_Camera_SenateGallery_TopDown",
        "hide_tag": INTERIOR_TOPDOWN_INSPECTION["hide_tag"],
        "visible_tag": INTERIOR_TOPDOWN_INSPECTION["visible_tag"],
        "visible_mesh": "capitol_public_interior_schematic.obj",
        "label_filter": "senate gallery",
        "purpose": "Public schematic Senate gallery inspection from a high top-down camera.",
        "public_accuracy": "public_schematic_non_operational",
        "person_specific": False,
    },
...
LABEL_COLORS = {
    ...
    "surface_aging_detail": (180, 165, 130, 255),
...
def spawn_high_quality_grounds_trees() -> dict[str, Any]:
    """Replace omitted allee blockouts with the accepted winter Hornbeam derivative."""
    stats: dict[str, Any] = {
        "asset_path": HIGH_QUALITY_GROUNDS_TREE_ASSET_PATH,
        "candidate_count": 0,
        "spawned_actor_count": 0,
        "asset_loaded": False,
        "blockout_geometry_omitted": True,
    ...
    try:
        ...
        details = [
            detail
            for detail in data.get("exterior", {}).get("grounds_details", [])
            if detail.get("kind") == "public_tree_allee"
        ...
        try:
            ...
            log(f"Winter grounds tree asset bounds fallback used: {exc}")
        for detail in details:
            center = detail.get("center_m", [0.0, 0.0, 0.0])
            scale = float(detail.get("instance_height_m", 13.6)) * 100.0 / native_height_cm
            base_z_cm = float(detail.get("instance_base_z_m", 0.0)) * 100.0
            actor = unreal.EditorLevelLibrary.spawn_actor_from_object(
                asset,
                unreal.Vector(
                ...
                unreal.Rotator(0.0, float(detail.get("instance_yaw_deg", 0.0)), 0.0),
            )
            if not actor:
                continue
            actor.set_actor_scale3d(unreal.Vector(scale, scale, scale))
            actor.set_actor_label(f"CapitolMap_HQWinterTree_{detail.get('name', 'tree')}")
            actor.set_folder_path(HIGH_QUALITY_GROUNDS_TREE_FOLDER)
            set_actor_tags(actor, ["CapitolMap_HighQualityWinterTree", "CapitolMap_PublicTreeAllee"])
            configure_static_mesh_component(actor.get_component_by_class(unreal.StaticMeshComponent))
            stats["spawned_actor_count"] += 1
    except Exception as exc:
        log(f"High-quality winter grounds tree replacement skipped: {exc}")
    return stats
...
def spawn_scene_setup() -> dict[str, Any]:
    ...
    grounds_tree_stats = spawn_high_quality_grounds_trees()
    ...
    return {
        ...
        "high_quality_grounds_trees": grounds_tree_stats,
    }
    ...
    try:
        ...
        report = {
            ...
            "metadata_counts": {
                ...
                "surface_aging_details": len(data.get("interior", {}).get("surface_aging_details", [])),
            ...
            "inspection_workflows": UNREAL_INSPECTION_WORKFLOWS,
            "inspection_workflow_count": len(UNREAL_INSPECTION_WORKFLOWS),
            "inspection_workflow_camera_labels": [
                workflow["camera_label"] for workflow in UNREAL_INSPECTION_WORKFLOWS.values()
            ],
