...
The current validation report counts 1,110,650 generated texture coordinates across the five OBJ meshes.
...
- 1,775 Capitol facade/furniture detail records, including 266 facade window mullions, 116 cornice brackets, 96 dome shell panel frames, 90 facade weathering stain records, 70 facade ashlar course records, 68 vertical stone joint records, 55 roof surface joint records, 32 worn plaza/step patch records, 32 public roof dormers, 32 dome drum arcade bays, 24 facade uplights, 24 visible dome curved-rib records, 16 public entry lamps, 16 dome drum spandrel panels, 16 lantern columns, 10 roof articulation volumes, 8 wing transition blocks, 8 courtyard/recess shadows, 8 skylight strips, 8 lantern window trim records, 12 public door surrounds, 8 public approach handrails, and 1 public Statue of Freedom silhouette
