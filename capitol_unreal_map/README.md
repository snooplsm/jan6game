...
- a public-only Capitol interior schematic with major spaces, generic office/support zones, Rotunda, House Chamber, Senate Chamber, galleries, generic chamber seating, public-art markers, visible lighting/wall-treatment details, and a joint-session House Chamber visual layout
- public-facing Capitol visual details including an authored Capitol landmark mesh, approximate revolving-door assemblies, layered pavilions, pediments, stone window surrounds, pilasters, stair treads, dentil/cornice courses, roof balustrades, dome ribs, dome bands, dome drum trim, lantern detail, entry lamps, bollards, and benches
...
The current validation report counts 759,498 generated texture coordinates across the five OBJ meshes.
...
- Capitol visual massing details including dome, lantern, porticos, columns, steps, plaza, grounds, public-facing revolving-door visuals, facade windows, stone window surrounds, public facade pilasters, stair tread records, dentil/cornice courses, roof balustrades, dome ribs, dome drum window trim, dome lateral bands, pediment relief panels, entry lamps, bollards, and benches
- 774 Capitol facade/furniture detail records
...
- 109 public chamber detail records for House/Senate rails, dais steps, rostrum desks, gallery rails, gallery benches, aisle edge markers, desk arc markers, backdrop panels, and flag standards
...
The current mesh-detail pass adds public streetscape props, traffic-signal heads, crosswalk striping, tree planters, public stop bars, lane arrows, bike symbols, curb-ramp visuals, wayfinding signs, authored public grounds details, Capitol facade windows, stone window surrounds, public facade pilasters, public stair treads, dentil courses, roof balustrades, dome balustrade posts, dome vertical ribs, dome drum window trim, dome lateral bands, lantern windows, entry lamps, bollards, benches, public chamber gallery benches, rostrum desks, additional public-art panels, and visible public light fixtures. The next visual-fidelity step is to replace procedural texture maps with curated real PBR texture sources where licensing permits and to add higher-fidelity modular meshes for facade ornament, landscape planting, and public streetscape fixtures.
