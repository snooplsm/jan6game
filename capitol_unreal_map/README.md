...
The two source-aligned House fountain surfaces use a dedicated `FountainWater`
fallback material rather than the generic bright-blue marker slot. It is a dark
neutral, 0.075-roughness, physically typical 0.5-specular translucent surface
with a restrained clear coat for shallow, nearly still January water. The PCG
manifest retains the same basins for a future connected Water-plugin upgrade;
the static fallback remains visible on an ordinary generated mesh import.
