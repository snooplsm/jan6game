...
The current validation report counts 1,628,208 vertices, 3,696,648 generated texture coordinates, and 1,980,812 triangles across the five OBJ meshes.
...
- 9,748 surrounding-building visual detail records, including nearby facade windows, roofline caps, cornice bands, parapet details, entries, entry stoops, ground-floor window panels, blind slats, sill blocks, vents, utility meter banks, service panels, address plaques, downspouts, street-level grime patches, rooftop details, supplemental roof equipment pads, HVAC fan housings, vent clusters, skylight domes, roof drain boxes, roof stain patches, facade pilasters, awnings, wall signs, and public-source height audit labels
- 1,432 roads/paths
