...
The current validation report counts 1,479,288 vertices, 3,246,576 generated texture coordinates, and 1,743,592 triangles across the five OBJ meshes.
...
- 60 generic office/support cells with desks, monitors, keyboards, paper stacks, task lamps, chairs, chair backs/arms/swivel bases, bookcases, storage cabinets, partitions, generic door panels, thresholds, public plaques, shared support tables, and public corridor bands
