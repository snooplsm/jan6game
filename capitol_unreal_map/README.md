...
The current validation report counts 964,286 generated texture coordinates across the five OBJ meshes.
...
- 1,686 Capitol facade/furniture detail records, including 266 facade window mullions, 116 cornice brackets, 96 dome shell panel frames, 90 facade weathering stain records, 70 facade ashlar course records, 68 vertical stone joint records, 55 roof surface joint records, 32 worn plaza/step patch records, 32 public roof dormers, 16 dome drum spandrel panels, 16 lantern columns, 10 roof articulation volumes, 8 wing transition blocks, 8 courtyard/recess shadows, 8 skylight strips, 12 public door surrounds, and 8 public approach handrails
...
- 244 public chamber detail records for House/Senate rails, dais steps, rostrum desks, public lecterns, work tables, gallery rails, gallery benches, gallery dividers, balcony fascia, aisle edge markers, aisle step lights, row-marker plaques, rostrum microphone clusters, public gallery stanchions, desk arc markers, desk surface markers, backdrop panels, and flag standards
