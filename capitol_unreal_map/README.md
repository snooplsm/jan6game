...
The current validation report counts 1,413,906 generated texture coordinates across the five OBJ meshes.
...
10. The script writes `generated/data/unreal_import_report.json` with the generated map path, imported asset paths, material asset paths, texture asset paths, environment setup, first-person collision/navigation/playtest setup, collision proxy setup, interior-inspection visibility tags, and metadata counts.
...
- higher-fidelity public room threshold material variation, exhibit-case placement, and transition lighting
