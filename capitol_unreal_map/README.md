...
- public-facing Capitol visual details including an authored Capitol landmark mesh, approximate revolving-door assemblies, layered pavilions, articulated roof/courtyard recesses, dormers, skylight strips, pediments, stone window surrounds, window mullions, door surrounds, pilasters, stair treads, approach handrails, dentil/cornice courses, cornice brackets, roof balustrades, dome ribs, dome bands, dome shell panel frames, dome drum trim/spandrels, lantern columns/balustrade, entry lamps, bollards, and benches
...
The current validation report counts 945,686 generated texture coordinates across the five OBJ meshes.
...
- 1,371 Capitol facade/furniture detail records, including 266 facade window mullions, 116 cornice brackets, 96 dome shell panel frames, 32 public roof dormers, 16 dome drum spandrel panels, 16 lantern columns, 10 roof articulation volumes, 8 wing transition blocks, 8 courtyard/recess shadows, 8 skylight strips, 12 public door surrounds, and 8 public approach handrails
