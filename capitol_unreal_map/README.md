...
- public-facing Capitol visual details including an authored Capitol landmark mesh, approximate revolving-door assemblies, layered pavilions, articulated roof/courtyard recesses, dormers, skylight strips, pediments, stone window surrounds, window mullions, ashlar stone courses, vertical stone joints, roof surface joints, door surrounds, pilasters, stair treads, approach handrails, dentil/cornice courses, cornice brackets, roof balustrades, dome ribs, dome bands, dome shell panel frames, dome drum trim/spandrels, lantern columns/balustrade, entry lamps, bollards, and benches
...
The current validation report counts 950,318 generated texture coordinates across the five OBJ meshes.
...
- Capitol visual massing details including dome, lantern, porticos, columns, steps, plaza, grounds, public-facing revolving-door visuals, facade windows, stone window surrounds, window mullions, public ashlar stone courses, vertical stone joints, roof surface joints, public door surrounds, public facade pilasters, stair tread records, approach handrails, dentil/cornice courses, cornice brackets, roof balustrades, articulated roof volumes, wing transition blocks, courtyard/recess shadow planes, dormers, skylight strips, dome ribs, dome shell panel frames, dome drum window trim/spandrel panels, dome lateral bands, lantern columns/balustrade, pediment relief panels, entry lamps, bollards, and benches
- 1,564 Capitol facade/furniture detail records, including 266 facade window mullions, 116 cornice brackets, 96 dome shell panel frames, 70 facade ashlar course records, 68 vertical stone joint records, 55 roof surface joint records, 32 public roof dormers, 16 dome drum spandrel panels, 16 lantern columns, 10 roof articulation volumes, 8 wing transition blocks, 8 courtyard/recess shadows, 8 skylight strips, 12 public door surrounds, and 8 public approach handrails
...
Viewer presets include overview, Capitol exterior, roads, public grounds, public grounds details, Capitol facade/roof details, public interior, Rotunda, House Chamber, Senate Chamber, joint-session House Chamber, public office/support details, public signage details, door hardware details, public furnishing details, wall finish details, floor finish details, ceiling/crown details, and gameplay item preview views. The label search and category filter can focus the camera on matching public spaces, chamber labels, seating labels, chamber detail labels, circulation detail labels, grounds detail labels, facade detail labels, office zones, office detail labels, signage detail labels, door detail labels, furnishing detail labels, wall finish detail labels, floor detail labels, ceiling detail labels, gameplay item labels, streets, or named surrounding buildings.
