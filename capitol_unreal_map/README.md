...
The current validation report counts 1,144,922 generated texture coordinates across the five OBJ meshes.
...
- 3,010 public chamber detail records for House/Senate rails, dais steps, rostrum desks, public lecterns, work tables, gallery rails, gallery benches, gallery dividers, balcony fascia, aisle edge markers, aisle step lights, row-marker plaques, rostrum microphone clusters, public gallery stanchions, desk arc markers, desk surface markers, 548 generic desk-surface insets, 548 generic document stacks, 548 generic desk microphone markers, 548 generic nameplate strips, 548 chair-arm pairs, row modesty panels, backdrop panels, and flag standards
